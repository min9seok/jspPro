   ...
   <table>     
     ...
     <tr>
       <td colspan="4" align="center">
          <a href="<%=path%>/board/edit.do?seq=${dto.seq}">수정하기</a>
          <a href="<%=path%>/board/delete.do?seq=${dto.seq}">삭제하기</a>
          <input type="button" id="modal" value="모달삭제" />
<!--           <a href="javascript:history.back()">Home</a> -->
		  <a href="<%= path %>/board/list.do">Home</a>
       </td> 
     </tr>
     </tfoot>              
   </table>
...
<h2>삭제하기</h2>
 <form method="POST" action="<%=path%>/board/delete.do?seq=${param.seq}">
 <table>
   <tr>
