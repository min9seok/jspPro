       ...
       <tr class="data">
         ...
         <td>     
           <c:if test="${dto.depth gt 0 }">
             ...
             <img src="/jspPro/days09/replyboard/images/arr.gif">
           </c:if>
           ...
           <c:if test="${dto.newimg }">
             <img src="/jspPro/days09/replyboard/images/ico-new.gif">
           </c:if>
         </td>
         <td> 
           <c:if test="${ dto.ip != '0:0:0:0:0:0:0:1' }">
             <img src="/jspPro/days09/replyboard/images/star.gif">
<%-- 		     <img src="/jspPro/days09/replyboard/emoticon/${dto.writer }.gif"> --%>
           </c:if>
