   ...
   <table>     
     ...
     <tr>
       <td colspan="4" align="center">
          <a href="<%=path%>/cstvsboard/edit.htm?seq=${dto.seq}">수정하기</a>
          <a href="<%=path%>/cstvsboard/delete.htm?seq=${dto.seq}">삭제하기</a>
...
<h2>삭제하기</h2>
 <form method="POST" action="<%=path%>/cstvsboard/delete.htm?seq=${param.seq}">
 <table>
   <tr>
